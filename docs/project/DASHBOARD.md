...
- **Plan:** 6 · **Build:** 8 · **Test:** 0 · **PR:** 0 · **Deploy:** 0 · **Archived:** 0 (excluded from totals)
...
| Docker & Deploy Infrastructure | In progress | 0 | 0 | 0 | 3 | 0 | 0% | `░░░░░░░░░░░░` |
| CI Pipeline | In progress | 0 | 0 | 0 | 3 | 0 | 0% | `░░░░░░░░░░░░` |
| Project Process Adoption | In progress | 0 | 0 | 0 | 2 | 0 | 0% | `░░░░░░░░░░░░` |

## Now — in progress (Build / Test / PR)

- **Add multi-stage Dockerfile and .dockerignore** — _Docker & Deploy Infrastructure_ · M · stage: build
- **Add docker-compose base + dev/test/prod overrides** — _Docker & Deploy Infrastructure_ · M · stage: build
- **Document Docker workflows in docs/setup.md and README** — _Docker & Deploy Infrastructure_ · S · stage: build
- **Add GitHub Actions CI workflow (lint/test/build)** — _CI Pipeline_ · S · stage: build
- **Add Docker image build/smoke-test job to CI** — _CI Pipeline_ · S · stage: build
- **Enable branch protection requiring CI to pass before merge** — _CI Pipeline_ · S · stage: build
- **Adopt local Docket SDLC scaffolding (5-stage flow)** — _Project Process Adoption_ · L · stage: build
- **Add story-advance skill and adapt generation scripts for 6-folder scheme** — _Project Process Adoption_ · M · stage: build
